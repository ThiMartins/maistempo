...
class Alarme : BroadcastReceiver (){
    ...
    companion object {
        ...
        fun desabilitarAlarme(Contexto:Context){
            val Intencao = Intent(Chave.CHAVE_ALARME.valor)
    ...
    override fun onReceive(p0: Context?, p1: Intent?) {
        if(p0 != null && p1 != null){
            Notificacao().notificacaoCriar(p0, "15", 15, p0.getString(R.string.AtualizandoBanco), p0.getString(R.string.BancoMudanca), p0.getString(R.string.AtualizandoBanco))
