...
class FragmentResumo : Fragment(), FunctionsInterface {
        ...
        ProgressoFila?.addOnBarraChanged(object : OnBarraChanged{
            ...
            override fun setOnFinishListener(v: BarraProgresso?) {
                ...
                if (!email.isNullOrEmpty()) {
                    ...
                    CloudFunctions.adicionarNotaFila(LojaInfo?.id!!, Tipo?.valor!!, valorNota.toDouble(), Horas.toString(), this@FragmentResumo)
                    if(referencia != null){
    ...
    private fun recuperandoView() {
        ...
        //EnviarFilaMomento = this.view?.findViewById(R.id.EnviarFila)
